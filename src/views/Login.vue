    ...
    <div class="loginbox">
        <div class="login">
            ...
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0"
                     @keyup.enter.native.prevent="handleSubmit">
                ...
                <el-form-item prop="password">
                    <el-input type="text" prefix-icon="el-icon-lock" v-model="ruleForm.password" auto-complete="off"
                              placeholder="密码"></el-input>
                </el-form-item>

                <el-form-item>
                    <el-button :loading="Logining" @click.native.prevent="handleSubmit" type="primary"
                               style="width:100%;">登录
                    </el-button>
                </el-form-item>
            </el-form>
